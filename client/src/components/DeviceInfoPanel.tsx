...
export default function DeviceInfoPanel({ device, isLoading }: DeviceInfoPanelProps) {
  if (isLoading) {
    return (
      <div className="md:w-1/2 lg:w-3/5 overflow-y-auto border-r border-neutral-100 p-6">
  ...
  if (!device) {
    return (
      <div className="md:w-1/2 lg:w-3/5 overflow-y-auto border-r border-neutral-100 p-6 flex items-center justify-center">
  ...
  return (
    <div className="md:w-1/2 lg:w-3/5 overflow-y-auto border-r border-neutral-100">
